  ...
  return (
    <section className="flex w-full flex-col items-stretch justify-center max-md:max-w-full">
      <div className="bg-white flex min-h-[478px] w-full items-stretch gap-[40px_48px] flex-wrap p-16 max-md:max-w-full max-md:px-5">
        {/*Source: <a href="http://www.freepik.com">Designed by Dooder / Freepik</a>*/}
        <img
          loading="lazy"
          ...
          alt="Gallery image 1"
        />
        {/**Source: Photo by Photo By: Kaboompics.com: https://www.pexels.com/photo/image-of-old-building-on-american-banknote-4386157/ */}
        <img
          loading="lazy"
